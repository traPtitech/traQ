...
type ChannelRepository interface {
	...
	// GetDirectMessageChannelList 指定したユーザーが参加しているDMチャンネルを、メッセージの更新時間が新しい順に取得します
	GetDirectMessageChannelList(userID uuid.UUID, limit int) ([]*model.DMChannelMapping, error)
