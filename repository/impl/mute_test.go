...
func TestRepositoryImpl_MuteChannel(t *testing.T) {
	...
	assert.EqualError(repo.MuteChannel(user.ID, uuid.Nil), repository.ErrNilID.Error())
	assert.EqualError(repo.MuteChannel(uuid.Nil, channel.ID), repository.ErrNilID.Error())
...
func TestRepositoryImpl_UnmuteChannel(t *testing.T) {
	...
	assert.EqualError(repo.UnmuteChannel(uuid.Nil, channel.ID), repository.ErrNilID.Error())
	assert.EqualError(repo.UnmuteChannel(user.ID, uuid.Nil), repository.ErrNilID.Error())
