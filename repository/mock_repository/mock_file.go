...
//
//	mockgen -source=file.go -destination=mock_repository/mock_file.go -package=mock_repository
//
...
func (mr *MockFileRepositoryMockRecorder) DeleteFileMeta(ctx, fileID any) *gomock.Call {
...
func (mr *MockFileRepositoryMockRecorder) DeleteFileThumbnail(ctx, fileID, thumbnailType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileRepositoryMockRecorder) GetFileMeta(ctx, fileID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileRepositoryMockRecorder) GetFileMetas(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileRepositoryMockRecorder) IsFileAccessible(ctx, fileID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileRepositoryMockRecorder) SaveFileMeta(ctx, meta, acl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
