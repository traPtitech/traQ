/*
migrationパッケージでは、gopkg.in/gormigrate.v1を用いたデータベースマイグレーションコードを記述します。
...
更に、全てのマイグレーションを適用後の最新のデータベーススキーマに関する情報を、AllTables・AllForeignKeys・AllCompositeIndexes・AllCompositeUniqueIndexesを変更することによって記述してください。
