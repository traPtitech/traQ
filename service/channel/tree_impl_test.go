...
func makeTestChannelTree(t *testing.T) *treeImpl {
	...
	tree, err := makeChannelTree([]*model.Channel{
		{ID: cA, Name: "a", ParentID: uuid.Nil, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cAB, Name: "b", ParentID: cA, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		...
		{ID: cABF, Name: "f", ParentID: cAB, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cABFA, Name: "a", ParentID: cABF, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cABB, Name: "b", ParentID: cAB, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: false},
		{ID: cABBC, Name: "c", ParentID: cABB, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: false},
		{ID: cAD, Name: "d", ParentID: cA, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cE, Name: "e", ParentID: uuid.Nil, Topic: "", IsForced: true, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cEF, Name: "f", ParentID: cE, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cEFG, Name: "g", ParentID: cEF, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
		{ID: cEFGH, Name: "h", ParentID: cEFG, Topic: "", IsForced: false, Type: model.ChannelTypePublic, IsVisible: true},
