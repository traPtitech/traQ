...
func TestHandlers_GetClients(t *testing.T) {
	...
	c1 := env.CreateOAuth2PublicClient(t, rand, user.GetID())
	c2 := env.CreateOAuth2ConfidentialClient(t, rand, user2.GetID())
...
func TestHandlers_GetClient(t *testing.T) {
	...
	c1 := env.CreateOAuth2PublicClient(t, rand, user1.GetID())
	c2 := env.CreateOAuth2PublicClient(t, rand, user2.GetID())
	c3 := env.CreateOAuth2ConfidentialClient(t, rand, user1.GetID())
...
func TestHandlers_DeleteClient(t *testing.T) {
	...
	c1 := env.CreateOAuth2PublicClient(t, rand, user1.GetID())
	c2 := env.CreateOAuth2PublicClient(t, rand, user2.GetID())
	c3 := env.CreateOAuth2PublicClient(t, rand, user1.GetID())
	c4 := env.CreateOAuth2PublicClient(t, rand, user2.GetID())
	user1Session := env.S(t, user1.GetID())
	adminSession := env.S(t, admin.GetID())
